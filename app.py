...
TEXT = {
    "en": {
        ...
        "takeaway_text": "Your top 10% of customers are worth about **{ratio:.1f}x** the average customer. "
                          "**{at_risk_pct:.0f}%** of your customers look like they may be slipping away "
    ...
    "zh": {
        ...
        "takeaway_text": "你排名前10%的客户价值约为平均客户的 **{ratio:.1f} 倍**。"
                          "**{at_risk_pct:.0f}%** 的客户看起来可能正在流失（仍然活跃的概率较低）——"
                          "这些客户是挽留营销活动的良好目标。",
