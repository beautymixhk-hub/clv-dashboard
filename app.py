...
TEXT = {
    "en": {
        ...
        # --- AI features ---
        "tab_ai": "AI Insights",
        "ai_missing_key": "AI features are not configured yet. Add an `ANTHROPIC_API_KEY` in "
    ...
    "zh": {
        ...
        # --- AI features ---
        "tab_ai": "AI 洞察",
        "ai_missing_key": "AI 功能尚未配置。请在 设置 → Secrets 中添加 `ANTHROPIC_API_KEY` 以启用此标签页。",
...
#
# Set an ANTHROPIC_API_KEY in Settings -> Secrets (Streamlit Community
