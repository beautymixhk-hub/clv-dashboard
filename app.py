...
def build_pdf_report(summary, clv_horizon, exchange_rate, calibration_ok, ratio, at_risk_pct,
    ...
    _closing_img_w = 3.2 * inch
    _closing_img_h = _closing_img_w * (695 / 344)  # preserve original aspect ratio
    closing_img = RLImage("assets/closing_art.jpg", width=_closing_img_w, height=_closing_img_h)
